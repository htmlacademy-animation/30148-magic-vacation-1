  ...
  changeVisibilityDisplay() {
    ...
    this.screenElements.forEach((screen) => {
      ...
      if (screen.id === `story` && screen.classList.contains(activeClass)) {
        ...
        screen.classList.add(overlayClass);

        setTimeout(() => {
          screen.classList.add(hiddenClass);
          screen.classList.remove(overlayClass);
        }, 350);
      } else {
        screen.classList.add(hiddenClass);
        screen.classList.remove(activeClass);
...
/* harmony import */ var _modules_loading_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/loading.js */ "./source/js/modules/loading.js");
// modules
...
// init modules
Object(_modules_loading_js__WEBPACK_IMPORTED_MODULE_9__["default"])();
